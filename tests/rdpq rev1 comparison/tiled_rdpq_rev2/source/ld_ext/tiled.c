		...
		for(int sub_tile = 0; sub_tile < 4; ++sub_tile)
		{
			...
			{                                              
				...
				{                                             
					...
					rdpq_texture_rectangle(TILE0, screen_x, screen_y, screen_x + 16, screen_y + 16, s_0 + 16 * sub_tile, t_0, 1.f, 1.f);
				}
			}
			++tile_index;
		}
